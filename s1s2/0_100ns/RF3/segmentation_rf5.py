...
for n,k in enumerate(comb_array_sig[:,:]):
    ...
    coor_matrix.figure.savefig('inf_corr_matrix.'+str(k[0])+'.'+str(k[1])+'.'+str(k[2])+'.'+str(k[3])+'.png') 
    ...
    g.figure.savefig('inf_pdfs_i_e2.'+str(k[0])+'.'+str(k[1])+'.'+str(k[2])+'.'+str(k[3])+'.png') 
    ...
    h.figure.savefig('inf_pdfs_e1_e2.'+str(k[0])+'.'+str(k[1])+'.'+str(k[2])+'.'+str(k[3])+'.png') 
    ...
    plt.savefig('inf_segmented_map.'+str(k[0])+'.'+str(k[1])+'.'+str(k[2])+'.'+str(k[3])+'.png') 
    ...
    plt.savefig('inf_feats_importance.'+str(k[0])+'.'+str(k[1])+'.'+str(k[2])+'.'+str(k[3])+'.png') 
    ...
    df.to_csv(r"inf_pixel_prob_{}.csv".format(tag))
...
for n,k in enumerate(comb_array_sig[:,:]):
    ...
    fig, ax1 = plt.subplots(1,1,figsize=(10,10))
    coor_matrix = sn.heatmap(corr, annot=True)
    coor_matrix.figure.savefig('sup_corr_matrix.'+str(k[0])+'.'+str(k[1])+'.'+str(k[2])+'.'+str(k[3])+'.png') 
    result = future.predict_segmenter(features[:,:,[k[0],k[1],k[2],k[3]]], clf) - 1
    ...
    g.figure.savefig('sup_pdfs_mix_i_e2.'+str(k[0])+'.'+str(k[1])+'.'+str(k[2])+'.'+str(k[3])+'.png') 
    ...
    h.figure.savefig('sup_pdfs_e1_e2.'+str(k[0])+'.'+str(k[1])+'.'+str(k[2])+'.'+str(k[3])+'.png') 
    ...
    plt.savefig('sup_segmented_map.'+str(k[0])+'.'+str(k[1])+'.'+str(k[2])+'.'+str(k[3])+'.png') 
    ...
    plt.savefig('sup_feats_importance.'+str(k[0])+'.'+str(k[1])+'.'+str(k[2])+'.'+str(k[3])+'.png') 
    new_sh = int(features[:,:,[k[0],k[1],k[2],k[3]]].shape[0]*features[:,:,[k[0],k[1],k[2],k[3]]].shape[1])
    prob =  classif.predict_proba(features[:,:,[k[0],k[1],k[2],k[3]]].reshape(new_sh,features[:,:,[k[0],k[1],k[2],k[3]]].shape[2]))
    df = pd.DataFrame(classif.predict_proba(features[:,:,[k[0],k[1],k[2],k[3]]].reshape(new_sh,features[:,:,[k[0],k[1],k[2],k[3]]].shape[2])))
    df.to_csv(r"sup_pixel_prob_{}.csv".format(tag))

...
for n,k in enumerate(comb_array_sig[:,:]):
    ...
    #np.savetxt('sup_merged'+str(k[0])+'.'+str(k[1])+'.txt'  ,highs_merged  , fmt = "%s"  )
    ...
    #np.savetxt('sup_num_regions_highs_merged'+str(k[0])+'.'+str(k[1])+'.txt'  ,np.vstack(num_regions_highs_merged)     , fmt = "%s"  )
